...
export const CARRY_MEMORY_MODAL_HI: Record<string, CarryModalCopy> = {
  connection_named: {
    ...
    prompt: 'अभी कौन आपके दिल के करीब है?',
  ...
  growth_journal: {
    ...
    why_we_ask: 'जो आपने देखा उसे नाम देने से वह कुछ असली बन जाता है।',
  ...
  clarity_journal: {
    ...
    why_we_ask: 'प्रश्न लिखने से असली फ़ैसला उसके आसपास के शोर से अलग हो जाता है।',
    prompt: 'वो प्रश्न क्या है जिसके साथ आप सच में बैठे हैं?',
...
export const ACTION_FAMILY_COMPANION_DEFAULTS_HI: Record<JourneyActionFamily, string> = {
  ...
  heart:      'दिल पर हाथ रखना उस ओर लौटना है जो स्थिर है।',
  grounding:  'हम विचारों से उस ओर लौट रहे हैं जो सच में यहाँ है।',
  text_input: 'शब्दों में डालने से मन उसे अकेले उठाना बंद करता है।',
  voice_note: 'कभी-कभी दिल तब नरम होता है जब उसे सुना जाता है।',
...
const ROOM_ARRIVAL_DEFAULTS_HI: Record<string, string> = {
  ...
  room_connection: 'दिल दूसरों से दूर लग रहा है। आप आए। यही पहला कदम है।',
...
const BETWEEN_STEP_MATRIX_HI: Partial<Record<JourneyActionFamily, Record<string, string>>> = {
  mantra: {
    ...
    heart:      'ध्वनि को बैठने दें। अब दिल पर एक हाथ।',
  ...
  breathe: {
    ...
    heart:      'अच्छा। एक सांस ली। अब दिल पर एक हाथ।',
  ...
  heart: {
    text_input: 'आपका दिल स्थिर हुआ। अब जो वो थामे है उसे नाम दें।',
    carry:      'आपका दिल स्थिर हुआ। अब, किसी महत्वपूर्ण का नाम लें।',
    inquiry:    'आपका दिल स्थिर हुआ। अब, एक प्रश्न।',
    mantra:     'आपका दिल स्थिर हुआ। अब, आगे ले जाने की ध्वनि।',
    breathe:    'आपका दिल स्थिर हुआ। अब एक सांस।',
    '*':        'आपका दिल स्थिर हुआ। अब, धीरे से, आगे।',
  },
  grounding: {
