...
const AddPracticesModal: React.FC<AddPracticesModalProps> = ({
  ...
  const handleConfirm = () => {
    ...
    // ✅ Add new practice and clear only after success
  ...
  return (
    ...
    >
      <View style={styles.modalContent}>
        ...
        {/* Practice Name */}
        <TextComponent type="semiBoldText" style={{ ...styles.label, marginTop: 10 }}>
          Practice Name
        </TextComponent>
        <TextInput
