...
function iconForLabel(label: string): string {
  ...
  if (label === 'Touch ID' || label === 'Fingerprint') return 'finger-print-outline';
      ...
      <View style={styles.backdrop}>
        <View style={styles.sheet}>
          <View style={styles.iconWrap}>
            <Ionicons name={iconForLabel(biometricLabel) as any} size={44} color="#c9a84c" />
          </View>
          ...
          <TextComponent type="cardText" style={styles.subtitle}>
            Use {biometricLabel} to open KalpX quickly — no password needed next time.
          </TextComponent>

          <TouchableOpacity style={styles.enableBtn} onPress={onEnable} activeOpacity={0.85}>
            <Ionicons name={iconForLabel(biometricLabel) as any} size={18} color="#fff" />
