// Dashboard block (card): EntityRecognitionCard
...
const EntityRecognitionCard: React.FC<Props> = ({ block, screenData }) => {
  const payload = block?.payload ?? screenData?.entity_recognition ?? null;
