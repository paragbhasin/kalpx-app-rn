...
const toggleHealing = (key: string) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text  allowFontScaling={false} style={styles.title}>{t("learnMore.title")}</Text>

      <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : undefined} style={{ flex: 1 }}>
        <ScrollView style={styles.scroll} contentContainerStyle={{ padding: 16, paddingBottom: 120 }}>
          <Text  allowFontScaling={false} style={styles.titlesubText}>{t("learnMore.whatLearn")}</Text>
...
/>
          ...
          <View style={{ marginTop: 16 }}>
            <Text  allowFontScaling={false} style={{ fontSize: 16, fontWeight: "500", color: "#000", marginBottom: 4 }}>
