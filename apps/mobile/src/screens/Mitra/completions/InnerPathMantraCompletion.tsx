...
import { INNER_PATH_MANTRA_COMPLETION_COPY as COPY } from "../../../constants/completionCopy";
import {
...
export default function InnerPathMantraCompletion() {
  ...
  useEffect(() => {
    ...
    Promise.all([
      mitraInnerPathComplete("mantra", item_id),
      mitraTrackCompletion({ itemType: "mantra", itemId: item_id, source: "core", journeyId, dayNumber }),
    ])
    ...
    <SafeAreaView style={styles.safeArea}>
      <ImageBackground source={BEIGE_BG} style={styles.bg}>
        <RunnerCompletionView
          ...
          testID={__DEV__ ? "test_ip_mantra_completion_return" : undefined}
        />
      </ImageBackground>
    </SafeAreaView>
  );
