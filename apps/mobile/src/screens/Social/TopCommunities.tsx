          ...
          item.media_url
            ? {
                uri: item.media_url.startsWith("http")
                  ? item.media_url
                  : `${BASE_IMAGE_URL}${item.media_url}`,
              }
            : COMMUNITY_BACKGROUNDS[item.slug] ||
              COMMUNITY_BACKGROUNDS[item.id?.toString()] ||
    ...
    return (
      <View style={styles.paginationContainer}>
        ...
        >
          <Ionicons
            name="chevron-back"
            style={[styles.navArrow, page === 1 && { opacity: 0.3 }]}
          />
        </TouchableOpacity>
        ...
        >
          <Ionicons
            ...
            style={[
              styles.navArrow,
              page === pagination.totalPages && { opacity: 0.3 },
            ]}
          />
        </TouchableOpacity>
      </View>
