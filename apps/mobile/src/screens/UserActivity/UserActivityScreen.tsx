        ...
        {item.is_useful_mark && (
          <View style={styles.usefulMarkHeader}>
            <View style={styles.usefulMarkRow}>
              <Text style={styles.usefulMarkTitle}>
                {t("community.activity.markedUseful")}
              </Text>
              <Text style={styles.dotSeparator}>•</Text>
              <Text style={styles.markedTime}>
                {moment(item.marked_useful_at)
                  .locale(i18n.language?.split("-")[0] || "en")
                  .fromNow()}
              </Text>
            </View>
            <Text style={styles.usefulCommentText}>
    ...
    <View style={styles.container}>
      <FlatList
        ...
        keyExtractor={(item, index) =>
          `${item._activity_id || item.id || "activity"}-${index}`
        }
        ListHeaderComponent={
                ...
                <View style={styles.avatarWrap}>
                  <Image
                    source={{
                      uri:
                        userProfile.avatar ||
                        `https://ui-avatars.com/api/?name=${encodeURIComponent(userProfile.profile_name || "User")}&background=EAEAEA&color=2F2F2F&size=128`,
                    }}
                    style={styles.avatar}
                    contentFit="cover"
                  />
            ...
            <View style={styles.statsRow}>
              <View style={styles.statItem}>
                ...
                <Text style={styles.statLabel}>
                  {t("community.activity.stats.karma")}
                </Text>
              </View>
              <View style={styles.statItem}>
                ...
                <Text style={styles.statLabel}>
                  {t("community.activity.stats.contribution")}
                </Text>
              </View>
              <View style={styles.statItem}>
                <Text style={styles.statValue}>{stats.days_active ?? 0} d</Text>
                <Text style={styles.statLabel}>
                  {t("community.activity.stats.onKalpx")}
                </Text>
              </View>
              <View style={styles.statItem}>
                ...
                <Text style={styles.statLabel}>
                  {t("community.activity.stats.activeIn")} {">"}
                </Text>
              </View>
            </View>
            ...
            <View style={styles.emptyContainer}>
              <View style={styles.emptyBox}>
                <Text style={styles.emptyTitle}>
                  {t("community.activity.empty.title")}
                </Text>
