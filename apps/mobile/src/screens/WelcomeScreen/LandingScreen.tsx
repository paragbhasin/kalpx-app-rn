        ...
        <ScrollView contentContainerStyle={{ paddingBottom: 40 }}>
          <View>
            <Image
              ...
              resizeMode="contain"
            />
            <TextComponent type="headerBoldText" style={styles.welcome}>Welcome To</TextComponent>
            <TextComponent type="headerBigText" style={styles.kalpText}>{t("login.brand")}</TextComponent>
            <TextComponent type="headerText" style={styles.heading2}>{t("login.heading")}</TextComponent>
            <TouchableOpacity
              style={{
              ...
              activeOpacity={0.8}
            >
              <TextComponent type="headerText" style={{ ...styles.buttonText, alignSelf: "center" }}>
                {t("welcome.getStarted")}
              </TextComponent>
            </TouchableOpacity>

            <TextComponent type="mediumBigText" style={styles.joinText}>Join KalpX</TextComponent>
            <TextComponent type="mediumText" style={styles.joinSubText}>
            ...
            <FlatList
              ...
              renderItem={({ item }) => (
                ...
                >
                   <TextComponent type="mediumText" style={styles.flatText}>{item}</TextComponent>
                </View>
              )}
            />
          </View>
