...
function LeafIcon({ color }: { color: string }) {
  return (
    <svg width={22} height={22} viewBox="0 0 24 24" fill="none" aria-hidden="true">
      ...
      />
      <path d="M2 21L10 13" stroke={color} strokeWidth="1.5" strokeLinecap="round" />
    </svg>
  );
}
...
function BalanceIcon({ color }: { color: string }) {
  return (
    <svg width={22} height={22} viewBox="0 0 24 24" fill="none" aria-hidden="true">
      ...
      <line x1="3" y1="7" x2="1" y2="13" stroke={color} strokeWidth="1.5" strokeLinecap="round" />
      <line x1="1" y1="13" x2="7" y2="13" stroke={color} strokeWidth="1.5" strokeLinecap="round" />
      <path d="M1 13 Q4 17 7 13" stroke={color} strokeWidth="1.5" fill="none" strokeLinecap="round" />
      <line x1="21" y1="7" x2="23" y2="13" stroke={color} strokeWidth="1.5" strokeLinecap="round" />
      <line x1="17" y1="13" x2="23" y2="13" stroke={color} strokeWidth="1.5" strokeLinecap="round" />
      <path d="M17 13 Q20 17 23 13" stroke={color} strokeWidth="1.5" fill="none" strokeLinecap="round" />
    </svg>
  );
}
...
function LotusIcon({ color }: { color: string }) {
  return (
    <svg width={22} height={22} viewBox="0 0 24 24" fill="none" aria-hidden="true">
      <path d="M12 19 C12 19 8 14.5 8 10.5 C8 7.5 10 5.5 12 5.5 C14 5.5 16 7.5 16 10.5 C16 14.5 12 19 12 19Z" stroke={color} strokeWidth="1.4" strokeLinejoin="round" />
      <path d="M12 19 C12 19 6 16 4.5 12 C3.5 9 5 6.5 7 6.5 C9 6.5 11 9 10.5 12" stroke={color} strokeWidth="1.4" strokeLinejoin="round" />
      <path d="M12 19 C12 19 18 16 19.5 12 C20.5 9 19 6.5 17 6.5 C15 6.5 13 9 13.5 12" stroke={color} strokeWidth="1.4" strokeLinejoin="round" />
      <path d="M7 19 C7 19 4 17 4 14" stroke={color} strokeWidth="1.4" strokeLinecap="round" />
      <path d="M17 19 C17 19 20 17 20 14" stroke={color} strokeWidth="1.4" strokeLinecap="round" />
      <line x1="7" y1="19" x2="17" y2="19" stroke={color} strokeWidth="1.4" strokeLinecap="round" />
    </svg>
  );
}
...
function ChevronIcon() {
  return (
    <svg width={20} height={20} viewBox="0 0 24 24" fill="none" aria-hidden="true">
      <polyline points="9 18 15 12 9 6" stroke="#C79A2B" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
