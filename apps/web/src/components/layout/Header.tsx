...
export function Header({ transparent = false }: { transparent?: boolean }) {
  ...
  return (
    <>
      ...
      >
        {/* Logo */}
        <Link to="/en" style={{ display: 'flex', alignItems: 'center', textDecoration: 'none', flexShrink: 0 }}>
          <img
            src="/kalpx-logo.png"
            alt="KalpX"
        ...
        <nav className="kalpx-desktop-nav" style={{ display: 'flex', alignItems: 'center', gap: 24 }}>
          ...
          {authed ? (
            <>
              ...
              <Link
                ...
                style={{ fontSize: 18, textDecoration: 'none', lineHeight: 1, color: 'var(--kalpx-text-soft)' }}
                title="Notifications"
              >
                🔔
              </Link>
              ...
              <div ref={dropdownRef} style={{ position: 'relative' }}>
                ...
                {dropdownOpen && (
                  <div style={{
                    ...
                    background: '#fff', border: '1px solid var(--kalpx-border-gold)',
                    borderRadius: 10, boxShadow: 'var(--kalpx-shadow-card)',
                    minWidth: 160, zIndex: 70, overflow: 'hidden',
                  }}>
                    {[
                      ...
                      <Link
                        ...
                        style={{
                          ...
                          fontSize: 13, color: 'var(--kalpx-text)',
                          textDecoration: 'none',
        ...
        <button
          ...
          style={{
            background: 'none', border: 'none', cursor: 'pointer',
            fontSize: 22, color: 'var(--kalpx-text)', padding: '4px 8px',
          }}
        >
          ☰
        </button>
      ...
      {sidebarOpen && (
        <>
          ...
          >
            {/* Sidebar header */}
            <div style={{
              background: 'var(--kalpx-cta)', padding: '16px 20px',
              display: 'flex', alignItems: 'center', justifyContent: 'space-between',
            }}>
              {authed ? (
                <div style={{
                  width: 40, height: 40, borderRadius: '50%',
                  background: '#fff', color: 'var(--kalpx-cta)',
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                ...
                <img src="/kalpx-logo.png" alt="KalpX" style={{ height: 28, width: 'auto' }} />
              )}
              <button
                onClick={() => setSidebarOpen(false)}
                style={{ background: 'none', border: 'none', cursor: 'pointer', fontSize: 22, color: '#fff', lineHeight: 1 }}
              >
                ×
              </button>
            </div>
            ...
            {/* Auth action */}
            <div style={{ padding: '16px 24px', borderTop: '1px solid var(--kalpx-border-gold)' }}>
              {authed ? (
                <button
                  onClick={handleLogout}
                  style={{
                    width: '100%', padding: '12px', borderRadius: 'var(--kalpx-r-lg)',
                    background: 'none', border: '1px solid var(--kalpx-border)',
                ...
                <Link
                  ...
                  style={{
                    ...
                    padding: '12px', borderRadius: 'var(--kalpx-r-lg)',
                    background: 'var(--kalpx-cta)', color: '#fff',
            ...
            <div style={{ padding: '12px 24px 20px', textAlign: 'center' }}>
              <p style={{ fontSize: 12, color: 'var(--kalpx-text-muted)', marginBottom: 8 }}>Follow us</p>
              <div style={{ display: 'flex', gap: 12, justifyContent: 'center' }}>
                <a href="https://www.instagram.com/kalpxofficial" target="_blank" rel="noopener noreferrer"
                  style={{ fontSize: 12, color: 'var(--kalpx-cta)', textDecoration: 'none', fontWeight: 600 }}>
                  Instagram
                </a>
                <a href="https://www.facebook.com/kalpxofficial" target="_blank" rel="noopener noreferrer"
                  style={{ fontSize: 12, color: 'var(--kalpx-cta)', textDecoration: 'none', fontWeight: 600 }}>
                  Facebook
                </a>
              </div>
