...
export const ACTION_FAMILY_COMPANION_DEFAULTS: Record<JourneyActionFamily, string> = {
  ...
  breathe:    'Before clarity, the body needs one steady rhythm.',
  ...
  inquiry:    'Mitra is helping you find the question underneath the noise.',
...
export const STEP_INTRO_LINES: Record<JourneyActionFamily, string> = {
  ...
  inquiry:    'A question beneath the noise',
