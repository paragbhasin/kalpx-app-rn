...
export const CLEANUP_FIELDS: Record<string, string[]> = {
  ...
  checkin: [
    ...
    'checkin_ack_accent',
    // Vue parity fields — present in Vue but missing from RN source; added here so
    // @kalpx/contracts is the complete canonical checkin cleanup set.
    'checkin_ack_headline',
    'checkin_ack_body',
    'checkin_mantra_text',
    'checkin_mantra_devanagari',
    'checkin_ack_insight_headline',
    'checkin_ack_insight_body',
  ],
  trigger: [
    'trigger_mantra_text',
    'trigger_mantra_devanagari',
