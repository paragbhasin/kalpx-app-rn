import BN from "./locales/bn/mantras-bn.json";
import EN from "./locales/en/mantras-en.json";
import GU from "./locales/gu/mantras-gu.json";
import HI from "./locales/hi/mantras-hi.json";
import KN from "./locales/kn/mantras-kn.json";
import ML from "./locales/ml/mantras-ml.json";
import MR from "./locales/mr/matras-mr.json";
import OR from "./locales/or/mantras-or.json";
import TA from "./locales/ta/mantras-ta.json";
import TE from "./locales/te/mantras-te.json";
