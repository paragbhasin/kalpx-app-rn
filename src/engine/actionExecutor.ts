...
import {
  ...
  patchCompanionState,
  getClearWindow,
  // Week 7 — Why-This L2/L3, Grief/Loneliness, Joy signal (all 404-tolerant)
  getPrinciple,
  getPrincipleSource,
  getGriefContext,
...
export async function executeAction(
  ...
  try {
    ...
    switch (type) {
      ...
      // ================================================================
      // WEEK 7 — Why-This L2/L3 overlays.
      // Spec: overlay_why_this_level_2.md, overlay_why_this_level_3.md.
      // Both endpoints are 404-tolerant; on null the sheet renders a quiet
      // "not available" state rather than erroring.
      // ================================================================
