...
export default function ClassBookingScreen({ navigation }) {
    ...
    return (
        ...
        >
            ...
            <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "center" }}>
                <View style={{ alignItems: "center", }}>
                    <View style={{ backgroundColor: Colors.Colors.App_theme, borderRadius: 20, alignItems: 'center', width: 40, height: 40 }}>
                        <TextComponent type='headerText' style={{ AlignCenter: "center", marginTop: 10 }}>1</TextComponent>
                    </View>
            ...
            />
            <TouchableOpacity style={{ backgroundColor: Colors.Colors.App_theme, paddingVertical: 10, paddingHorizontal: 22, borderRadius: 10, alignItems: "center", marginTop: 20, alignSelf: "flex-end" }}>
                <TextComponent style={{
