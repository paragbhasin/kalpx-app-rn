        ...
        <ImageBackground source={require("../../../assets/hoomepagebg.jpg")} style={styles.background}>
          <ScrollView contentContainerStyle={styles.scrollContainer} keyboardShouldPersistTaps="handled">
            ...
            <View style={{...styles.card,height:"75%",}}>
              <Text style={styles.cardTitleLine1}>{t("forgotPassword.Verification")}</Text>
                  ...
                  return (
                    <View style={{ flex: 1 }}>
                      ...
                      <TextInput
                        ...
                        secureTextEntry
                      />
                      {errors.password1 && touched.password1 && <Text style={styles.error}>{errors.password1}</Text>}

                      <Text style={styles.subTitle}>{t("forgotPassword.confirmPassword")}</Text>
                      <TextInput
                        style={styles.input}
                        ...
                        secureTextEntry
                      />
                      {errors.password2 && touched.password2 && <Text style={styles.error}>{errors.password2}</Text>}
