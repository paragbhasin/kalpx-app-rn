...
export default function VerificationScreen({ navigation, route }) {
            ...
            <View style={{...styles.card,height:"75%",}}>
              ...
              >
                {({ handleSubmit, values, setFieldValue, errors, touched, handleChange, handleBlur, isValid }) => {
                  ...
                  return (
                    <View style={{ flex: 1 }}>
                      {/* <TextComponent type="headerText" style={styles.subTitle}>{t("forgotPassword.enterVerificationCode")}</TextComponent> */}
                      <TextComponent type="headerText" style={{...styles.subTitle,marginTop:15}}>{t("forgotPassword.enterNewPassword")}</TextComponent>
                      <TextInput
  ...
  allowFontScaling={false}  
                        ...
                        secureTextEntry
                      />
                      {errors.password1 && touched.password1 &&  <TextComponent type="mediumText"  style={styles.error}>{errors.password1}</TextComponent>}
                       <TextComponent type="headerText"  style={styles.subTitle}>{t("forgotPassword.confirmPassword")}</TextComponent>
                      <TextInput
                                              keyboardType="email-address"      
  textContentType="emailAddress"        
  autoCapitalize="none"                 
  ...
  allowFontScaling={false}  
                        ...
                        secureTextEntry
                      />
                      {errors.password2 && touched.password2 &&  <TextComponent type="mediumText"  style={styles.error}>{errors.password2}</TextComponent>}
