...
const StoreDetailView = () => {
    ...
    const trustedStores = [
        ...
        },
        {
            ...
            open: "9:00 AM",
            close: "9:00 PM",
            description: "Professional festive and ceremonial decoration services.",
            type: "service",
        },
    ];

    const store = trustedStores.find((item) => item.id === id) || trustedStores[0];
