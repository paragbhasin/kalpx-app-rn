  ...
  socialLoginUser({ provider: "google", access_token }, async (res) => {
    ...
    if (res.success) {
      ...
      if (keepLoggedIn) {
        ...
        await AsyncStorage.setItem("googleUser", JSON.stringify(result.data.user));
      }
...
/> */}
            ...
            <View style={styles.card}>
              ...
              <TextComponent type="loginHeaderText" style={styles.cardTitleLine2}>{t("login.cardTitleLine2")}</TextComponent>
              <TextComponent  type="streakSubText" style={styles.subTitle}>{t("login.subTitle")}</TextComponent>
  ...
  allowFontScaling={false}             
                    ...
                    />
                    {errors.username && touched.username && <TextComponent type="mediumText" style={styles.error}>{errors.username}</TextComponent>}

                    {otpSent && <TextComponent type="mediumText"  style={styles.success}>{t("login.otpSent")}</TextComponent>}
                    ...
                    <View style={styles.row}>
                      ...
                      >
                        <View style={[styles.checkbox, keepLoggedIn && styles.checked]}>
                          {keepLoggedIn &&  <TextComponent type="headerText" style={styles.checkmark}>✓</TextComponent>}
                        </View>
                        <TextComponent type="semiBoldText" style={styles.checkboxLabel}>{t("login.keepLoggedIn")}</TextComponent>
                      </TouchableOpacity>

                      <TouchableOpacity onPress={() => navigation.navigate("ForgotPassword")}>
                        <TextComponent type="semiBoldText" style={styles.forgot}>{t("login.forgotPassword")}</TextComponent>
                      </TouchableOpacity>
                    </View>
...
<LoadingOverlay visible={loading} text="Signing in..." />
                    <View style={styles.footerContainer}>
                      ...
                      <TouchableOpacity onPress={() => navigation.navigate("Signup")}>
                        <TextComponent type="cardText" style={styles.login}>{t("login.register")}</TextComponent>
                      </TouchableOpacity>
                    </View>
                  </>
                )}
