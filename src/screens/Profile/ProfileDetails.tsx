        ...
        <View style={{ marginHorizontal: 20 }}>
          ...
          */}
          ...
          {formik.touched.language && formik.errors.language && (
            <Text style={styles.errorText}>{formik.errors.language}</Text>
          )}
              <Text style={{ marginTop: 10 }}>{t("profileScreen.languageInstruction")}</Text>

          {/* 🕒 Timezone */}
          <Text style={styles.label}>{t("profileScreen.chooseTZ")}</Text>
          <Dropdown
            data={timezones}
            labelField="label"
            valueField="value"
          ...
          {formik.touched.timezone && formik.errors.timezone && (
            <Text style={styles.errorText}>{formik.errors.timezone}</Text>
          )}

          {/* 🔔 Reminders */}
          <Text style={[styles.label, { marginTop: 20 }]}>{t("profileScreen.Reminders")}</Text>
          <View style={{ flexDirection: "column", gap: 10 }}>
            ...
            >
              <Ionicons
                ...
                color="#a67c52"
              />
              <Text style={{ marginLeft: 10 }}>{t("profileScreen.emailNotifications")}</Text>
            </Pressable>
            ...
            >
              <Ionicons
                ...
                color="#a67c52"
              />
              <Text style={{ marginLeft: 10 }}>{t("profileScreen.pushNotifications")}</Text>
            </Pressable>
          </View>
        </View>
      </ScrollView>
